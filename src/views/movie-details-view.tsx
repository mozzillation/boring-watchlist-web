...
import { buildTMDBImageUrl, formatRuntime } from '@/lib/tmdb/utils/helpers'
...
const MovieDetailsView: React.FC<MovieDetailsViewProps> = ({ movie }) => {
  ...
  const backdrop = buildTMDBImageUrl(movie.backdrop_path, 'w154')
  const poster = buildTMDBImageUrl(movie.poster_path, 'w342')
